...
# MAGIC
# MAGIC This pipeline:
# MAGIC 1. Reads new `.txt` files from the `fault_reports` UC Volume as a streaming table.
...
@dlt.table(
    ...
    comment="Raw text from fault report files in the UC Volume (streaming, auto-loader)",
